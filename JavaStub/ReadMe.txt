========================================================================
    APPLICAZIONE WIN32: cenni preliminari sul progetto JavaStub
========================================================================

La creazione guidata applicazione ha creato questa applicazione JavaStub.

Questo file contiene un riepilogo del contenuto di ciascun file che fa parte
dell'applicazione JavaStub.
...
JavaStub.ico
    File di icona utilizzato come icona dell'applicazione (32x32). Tale icona è inclusa dal file di risorse principale JavaStub.rc.

small.ico
    File di icona contenente una versione di dimensioni inferiori (16x16) dell'icona dell'applicazione. Tale icona è inclusa dal file di risorse principale JavaStub.rc.
